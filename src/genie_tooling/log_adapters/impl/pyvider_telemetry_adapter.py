...
class PyviderTelemetryLogAdapter(LogAdapter, CorePluginType):
    ...
    _pyvider_logger: Optional[Any] = None # pyvider.telemetry.PyviderLogger
    ...
    async def setup(self, config: Optional[Dict[str, Any]] = None) -> None: # Changed from setup_logging
        ...
        pyvider_service_name = cfg.get("service_name") # Can be None, Pyvider will use its default
        ...
        try:
            ...
            self._pyvider_logger = pyvider_global_logger # Use the global instance configured by setup
